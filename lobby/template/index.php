        ...
        <div id = "outer-lobby-container">
                ...
                <div id="lobby-playerlistandsettings">
                    <div id="host-settings-buttons">
                            <div id="word-search-grid" id="word-search-grid">
                                ...
                                <div class="row">
                                    <div data-special-cell="settings">S</div>
                                    ...
                                    <div data-special-cell="themes">T</div>
                                    <div data-special-cell="themes">H</div>
                                    <div data-special-cell="themes">E</div>
                                    <div data-special-cell="themes">M</div>
                                    <div data-special-cell="themes">E</div>
                                    <div data-special-cell="themes">S</div>
                                    <div class="cell">D</div>
                                    <div class="cell">P</div>
                                </div>
                                <div class="row">
                                    <div data-special-cell="settings">E</div>
                                ...
                                <div class="row">
                                    <div data-special-cell="settings">T</div>
                                    <div class="cell">O</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="cell">T</div>
                                    <div class="cell">I</div>
                                    <div data-special-cell="start">S</div>
                                    <div data-special-cell="start">T</div>
                                    <div data-special-cell="start">A</div>
                                    <div data-special-cell="start">R</div>
                                    <div data-special-cell="start">T</div>
                                    <div class="cell">P</div>
                                    <div class="cell">I</div>
                                ...
                                <div class="row">
                                    <div data-special-cell="settings">I</div>
                                    <div class="cell">X</div>
                                    <div class="cell">V</div>
                                    <div class="cell">B</div>
                                ...
                                <div class="row">
                                    <div data-special-cell="settings">N</div>
                                    <div class="cell">D</div>
                                    <div class="cell">S</div>
                                    <div class="cell">A</div>
                                    <div class="cell">E</div>
                                ...
                                <div class="row">
                                    <div data-special-cell="settings">G</div>
                                    <div class="cell">H</div>
                                    <div class="cell">J</div>
                                    <div class="cell">E</div>
                                    <div class="cell">L</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="cell">L</div>
                                    <div class="cell">Q</div>
                                    <div data-special-cell="how-to-win!">H</div>
                                    <div data-special-cell="how-to-win!">O</div>
                                    <div data-special-cell="how-to-win!">W</div>
                                    <div data-special-cell="how-to-win!"></div>
                                    <div data-special-cell="how-to-win!">T</div>
                                    <div data-special-cell="how-to-win!">O</div>
                                    <div data-special-cell="how-to-win!"></div>
                                    <div data-special-cell="how-to-win!">W</div>
                                    <div data-special-cell="how-to-win!">I</div>
                                    <div data-special-cell="how-to-win!">N</div>
                                    <div data-special-cell="how-to-win!">!</div>
                                    <div class="cell">E</div>
                                </div>
                                <div class="row">
            ...
            <div id ="player-list-box">
                    ...
                    <div id="selected-theme-container">
                        ...
                        <div p="selected-theme-text">Current Theme</div>    
                    </div>
            </div>
        </div>
    </body>
